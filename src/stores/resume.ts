...
export const useResumeStore = defineStore('resume', () => {
  const profile = ref({
    ...
    bioParagraphs: [
      '你好，我是李書賢（Scott），來自台南、目前在台中生活與工作。擁有六年半的軟體工程師經驗，主要專注在 Web 前端與跨平台 App 開發，平常主力技術是 Vue 3、Flutter 以及原生 iOS。',
      '我畢業於實踐大學資訊模擬與設計學系。因為科系結合了設計與資訊，讓我在切版和開發互動介面時，特別注重畫面流暢度與使用者體驗。大學專題時我主要負責程式開發和 Unity 整合，曾代表學校參賽拿到優勝；畢業前後也很幸運去過北京的軟體公司實習參與 VR 製作，並於畢業之後考取了 Oracle Java 證照，這段經歷讓我養成了快速學習新技術的習慣。',
      '在中佑資訊這六年半裡，我參與過許多核心專案：像是一手包辦即時通訊軟體的 Web 端與客服控端後台，支援一對多群組聊天室、樂觀更新與 Server Ack，並導入虛擬列表與分批載入解決萬筆訊息渲染效能瓶頸；另外也負責體育遊戲 Web 端看板與跨平台 App，具備體育賽事獨立上架與核心模組 SDK 封裝能力；我也推進舊系統由 Vue 2 升級重構至 Vue 3，並為團隊導入 Vitest 單元測試體系。平常我們團隊採用 Scrum 敏捷流程與每日站會，能精確掌握自己的開發時程，也常擔任前端窗口協助團隊做代碼審查與技術交流。',
      '我的個性隨和、配合度高，在團隊協作時比起爭執，我更習慣先傾聽企劃、美術和後端夥伴的想法，再一起討論出最合適的技術解法。工作之餘我喜歡溜滑板、打羽球、健身或打陀螺，這些運動能讓我徹底放鬆身心，也讓我保持專注與解決問題的耐心。',
    ],
    social: {
